...
public class EntitiesApiTest {
     ...
     */
    @Test
    public void replaceAllEntityAttributesTest() throws Exception {
        String entityId = null;
        String contentType = null;
     ...
     */
    @Test
    public void retrieveEntityTest() throws Exception {
        String entityId = null;
        String type = null;
        String attrs = null;
        String metadata = null;
     ...
     */
    @Test
    public void retrieveEntityAttributesTest() throws Exception {
        String entityId = null;
        String type = null;
        String attrs = null;
        String metadata = null;
     ...
     */
    @Test
    public void updateExistingEntityAttributesTest() throws Exception {
        String entityId = null;
        String contentType = null;
     ...
     */
    @Test
    public void updateOrAppendEntityAttributesTest() throws Exception {
        String entityId = null;
        String contentType = null;
